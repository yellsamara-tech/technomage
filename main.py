...
from db import init_db, add_user, get_user, update_status, get_all_users, get_admins, make_admin, revoke_admin, delete_user, get_status_history
...
async def admin_status_stats(message: types.Message):
    ...
    for u in users:
        ...
        status = history[-1] if history else "Не установлен"
